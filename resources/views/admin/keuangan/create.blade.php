    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('admin.keuangan.store') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="jenis_transaksi" class="form-control" value="{{ old('jenis_transaksi') }}">
            </div>
            <div class="mb-3">
                <label class="form-label">Jumlah Uang</label>
                <input type="number" step="0.01" name="jumlah_uang" class="form-control" value="{{ old('jumlah_uang', 0) }}" required>
            </div>
            <div class="mb-3">
